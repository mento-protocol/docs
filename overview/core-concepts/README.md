...
| [Oracles, price feeds & circuit breakers](oracles-and-circuit-breakers.md) | How the pool gets the swap rate (OracleAdapter, BreakerBox), validity, and when trading is halted. |
