---
description: >-
  How the supply of Mento assets is achieved in the Mento protocol using the
...
### Multi-mento Deployment[​](https://docs.celo.org/celo-codebase/protocol/stability/doto#multi-mento-deployment) <a href="#multi-mento-deployment" id="multi-mento-deployment"></a>
