...
- **FPMM rebalancing** — The **CDP strategy** is allowlisted on pools that pair a CDP-backed stable (e.g. GBPm) with another asset. When the pool is imbalanced, the strategy returns the required token using the stability pool and CDP mechanics. See [Rebalancing & strategies](fpmm/rebalancing-and-strategies.md).
...
- [Rebalancing & strategies](fpmm/rebalancing-and-strategies.md) — How the CDP strategy rebalances FPMM pools.
